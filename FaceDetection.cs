...
namespace FaceDetectionPractices
{
    public class FaceDetection
    {
        ...
        public void HeadPositionTest()
        {
            ...
            ShapePredictor pose_model = new ShapePredictor();
            pose_model = ShapePredictor.Deserialize("shape_predictor_68_face_landmarks.dat");
            ...
            foreach (var face in faces)
            {
                shapes.Add(pose_model.Detect(cimg, face));
            }
        ...
        public void FaceCoordinateTest()
        {
            ...
            detector.Dispose();
            cimg.Dispose();
            Cv2.ImShow("Output", result.ToMat());
        }
    }
}
